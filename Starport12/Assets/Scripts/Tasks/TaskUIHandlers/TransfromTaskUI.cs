...
{
    public class TransfromTaskUI : MonoBehaviour, ITaskUIHandler
    {
        ...
        private ObjectTransfomTaskType TaskType { get { return Instance.TaskType as ObjectTransfomTaskType; } }
        ...
        public void Start()
        {
            TaskType.ResourceRequirements.ForEach(req =>
            {
            ...
            TaskType.Assignments.ForEach(assignment =>
            {
